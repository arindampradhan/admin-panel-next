  ...
  return (
    <div>
      ...
      <main className="font-sans">
        <div className="bg-gray-50 relative flex min-h-screen flex-col justify-center overflow-hidden py-8 lg:py-12">
          <div className="shadow-slate-700/10 ring-gray-900/5 relative w-full bg-white px-6 py-12 shadow-xl ring-1 md:mx-auto md:max-w-3xl lg:max-w-4xl lg:pt-16 lg:pb-28">
            ...
            <div className="prose prose-slate mx-auto mt-8 lg:prose-xl ">
              <p className="lead">
              ...
              <pre>
                <code className="language-html">
                  ...
                  eating garlic bread with cheese to their{'\n'}
              ...
              <ul>
                ...
                <li>
                  <p>
                    A closing list item, but with no nested list, because why
                    not?
                  </p>
                </li>
              </ul>
